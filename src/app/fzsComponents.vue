    ...
    <div class="para">
      ...
      <table border='8'>
        ...
        <tr>
          ...
          <td><code>String</code></td>
          <td>N</td>
          <td>可取：<code>[mobile/bank/email/idNo/password/'']</code>当为空时，默认使用普通 text 无校验</td>
        </tr>
        <tr>
          <td>placeholder</td>
          <td><code>String</code></td>
        ...
        <tr>
          ...
          <td><code>String/Number</code></td>
          <td>N</td>
          <td>当 type 有值时，使用校验所设定的 maxLength，故设置了 type 值之后，<b
            class="danger">不要设置 maxLength</b></td>
        </tr>
        </tbody>
      </table>
      ...
      <div class="example">
        <div class="example-block">
          <p>theMobile 手机值为：{{theMobile}}</p>
          <fzs-input type="mobile" v-model="theMobile"></fzs-input>
        </div>

        <div class="example-block">
          <p>theValue 普通值为：{{theValue}}</p>
          <fzs-input v-model="theValue" placeholder="普通类型，可限定字符长度, 限定为10" maxLength=10></fzs-input>
        </div>
        ...
        <div class="example-block">
          <p>定长的密码类型：{{setLengthVal}}</p>
          <fzs-input type="password" v-model="setLengthVal" length='12' placeholder='请输入12位密码'></fzs-input>
        </div>
      </div>
    </div>
